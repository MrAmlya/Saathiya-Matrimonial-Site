<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="SaathiyaProjectFinal.login" EnableEventValidation="false" %>
                        ...
                        <div class="contact-form">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-1 col-sm-7 col-sm-offset-2">
                                    ...
                                    <asp:Button ID="Login_Button" class="btn btn-lg btn-black pull" runat="server" Text="LOGIN" OnClick="Login_Button_Click" />
                                    Not member yet? <a href="register.aspx">Register NOW!!</a>
                                </div>
                            </div>
                        </div>
                    </div>
